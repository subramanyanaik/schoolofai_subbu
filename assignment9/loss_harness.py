...
#
# Runs top to bottom on a Colab T4, on a local CUDA GPU, or on CPU (slower; the memory
# section reports analytic bytes instead of measured ones when CUDA is absent).
